...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>P</span>izzamandu.</a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Each pizza is handcrafted by passionate chefs using fresh ingredients. Our pizzas are made to ensure the highest quality and flavor in every bite.</p>
      ...
      <div class="box">
         ...
         <h3>Fast Delivery</h3>
         <p>We understand that your time is valuable, and that every minute of the day counts. That is why we deliver quickly! So you can spend more time doing what you enjoy.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/about-3.png" alt="">
         <h3>Pizza and Memories</h3>
         <p>Nothing brings together friends and family like a delicious pizza. You'll have an unforgettable experience with our delicious pizza made with the freshest ingredients.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Pin Code :</span>
            <input type="number" name="pin_code" class="box" required placeholder="e.g. 44600" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;">
         </div>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         <div class="accordion-heading">
            <span>To which locations do you deliver? </span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         We deliver to any locations inside of ring road and its periphery. However, we plan to deliver food to all of Kathmandu valley in the near future.</p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Generally it takes 45 minutes to one hour to deliver your order.We do our best to deliver your order as soon as possible. In order to make sure that the food is delivered on time, you may order food well in advance, even a few hours before the time you want your food to be delivered.</p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>Can I cancel my order if needed? </span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         You can. However, you need to inform us over the phone on time. If the ordered food is already prepared by the restaurant, you cannot cancel the order. </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>What is the delivery charge?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            We have different delivery charge for differnt places based on their location and number of items ordered.</p>
      </div>


      <div class="accordion">
         <div class="accordion-heading">
            <span>Is it cooked in oven or firewood?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Our pizzas are generally made in oven but we can make them in firewood if the costumers askes for it.</p>
      </div>
